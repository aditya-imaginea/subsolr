...
public class FieldTypeDefinition {
   ...
   public FieldTypeDefinition(String name, Class<? extends FieldType> fieldTypeClass, Integer positionIncrementGap,
         Similarity similarityClassName, List<Analyzer> analyzer) {
      this.name = name;
