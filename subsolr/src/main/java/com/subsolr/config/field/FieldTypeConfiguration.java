...
public class FieldTypeConfiguration {
   public static final Logger logger = LoggerFactory.getLogger(FieldTypeConfiguration.class);
   private final XPath xPath;
   private final String luceneVersion;
   private final XMLParserUtil xmlparserutil;
   
   public FieldTypeConfiguration(String luceneVersion,XPath xPath,XMLParserUtil xmlparserutil) {
