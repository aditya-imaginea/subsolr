...
/**
 * Methods to generate attributes dynamically for fields in a POJO, and to create IndexedCollections configured
 * dynamically to index these attributes.
 * 
...
public class DynamicIndexer {
   ...
   public static <O> Map<String, Attribute<O, Comparable>> generateAttributesForPojo(Class<O> pojoClass) {
      ...
      for (Field field : pojoClass.getDeclaredFields()) {
         if (Comparable.class.isAssignableFrom(field.getType())) {
            ...
            generatedAttributes.put(field.getName(),
                  ReflectiveAttribute.forField(pojoClass, fieldType, field.getName()));
         }
      }
    ...
    * @param <O>
    *           Type of objects stored in the collection
